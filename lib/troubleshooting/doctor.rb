# SOURCE: https://github.com/mislav/ssl-tools/blob/8b3dec4/doctor.rb
# ARTICLE: http://mislav.uniqpath.com/2013/07/ruby-openssl/
# Usage: ruby doctor.rb [HOST=status.github.com[:PORT=443]]
#
# Run this script per the article cited above to help troubleshoot
# any SSL / certificate issues that you may have.
